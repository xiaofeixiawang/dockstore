...
angular.module('dockstore.ui')
  .controller('SearchCtrl', [
    ...
    function ($scope, $rootScope, $q, $window, $location, $auth, $routeParams,
      ...
      $scope.listRemotePublishedContainers = function() {
        return ContainerService.getRemotePublishedContainerList()
          .then(
            function(containers) {
              for(var i=0;i<containers.length;i++){
                containers[i]["isRemote"]=true;
              }
      ...
      $scope.listRemotePublishedContainers();
